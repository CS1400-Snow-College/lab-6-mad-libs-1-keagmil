...
//char[] letters = storyWords.ToCharArray();

//for (int i = 0; i < storyWords.Length; i++)
{
    //Console.WriteLine($"index {i} + Letter {storyWords[i]}");
    foreach (string firstLetter in storyWords)
    {
    Console.WriteLine($" first Letter {firstLetter[0]}");
    }
}
